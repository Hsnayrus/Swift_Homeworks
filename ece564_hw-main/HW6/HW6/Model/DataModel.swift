...
func getTeams(_ people: [DukePerson]) -> [String]{
...
func getTeamsDict(_ teamSet: [String]) -> Dictionary<String, [DukePerson]>{
    var result: Dictionary<String, [DukePerson]> = Dictionary<String, [DukePerson]>()
    for team in teamSet{
...
var professorList: [DukePerson] = getProfessorList()
var TAList:[DukePerson] = getTAList()
var othersList: [DukePerson] = getOthersList()
var studentsList: [DukePerson] = getStudentsList()
var teams: [String] = getTeams(studentsList)
var teamWPeople: Dictionary<String, [DukePerson]> = getTeamsDict(teams)
var finalStudentsList = Array(teamWPeople.keys).sorted(by: <)

class DukePeople: ObservableObject{
    @Published var people: [DukePerson] = PeopleList
    
    func updateWithList(_ people: [DukePerson]){
        self.people = PeopleList
    }
    func count() -> Int{
        return people.count
    }
    init(_ people: [DukePerson]){
        self.people = people
    }
}

class DukeStudents: ObservableObject{
    @Published var students: Dictionary<String, [DukePerson]> = teamWPeople
    func updateWithDict(_ students: [String: [DukePerson]]){
        self.students = students
    }
    init(_ students: [String : [DukePerson]]){
        self.students = students
    }
}

class PersonObs: ObservableObject{
    @Published var person: DukePerson = DukePerson()
    func updatePerson(_ person: DukePerson){
        self.person += person
    }
    init(_ person: DukePerson){
        person += person
    }
}
